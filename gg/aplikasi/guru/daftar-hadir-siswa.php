...
<body>
<nav>
<a class="kembali" href="pelajaran.php?
	id-jenis-pelajaran=<?php echo $id_jenis_pelajaran; ?>&&
	id-kelas=<?php echo $id_kelas; ?>"><i class="fas fa-chevron-left"></i> Kembali</a>
</nav><br><br><br>

	<table align="center" >
	<tr>
			<td class="head-table" colspan="6" align="center">nama siswa</td>
		</tr>
		<table align="center">
