...
<table align="center">
<tr>
			<td class="head-table" colspan="6" align="center">daftar hadir siswa kelas <?php echo $data_guru["nama_kelas"]; ?></td>
			
		</tr>
		<tr>
		<td class="head-table" colspan="6" align="center">jumlah pelajaran yang diunggah : <?php echo $data_pelajaran["jumlah_pelajaran"]; ?></td>
		</tr>
...
echo $data_jumlah_hadir_siswa["jumlah_hadir"];?></td>
			<td  ><?php
