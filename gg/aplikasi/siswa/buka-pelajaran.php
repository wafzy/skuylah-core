...
<nav>
<a class="kembali" href="../siswa/pelajaran.php?id-mata-pelajaran=<?php echo $id_mata_pelajaran; ?>"><i class="fas fa-chevron-left"></i> kembali</a></nav><br><br><br>
<div id="container">
	 <center><iframe  style="solid #666CCC" src="../file/<?php echo $data_pelajaran["pelajaran"]; ?> " height="900" width="90%" ></iframe></center></div>
	...
	<form  method="post">
		...
		<?php elseif(mysqli_num_rows($cek_kehadiran_siswa) > 0) : ?>
			<p class="sdh-absen" align="center">sudah absen <i class="fas fa-clipboard-check"></i></p>
		<?php endif; ?>
